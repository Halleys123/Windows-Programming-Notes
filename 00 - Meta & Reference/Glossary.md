...
2. [[Windows NT and Windows 98#Concurrency and Parallelism in Windows|Concurrency]] - Multiple tasks make progress over time, even on one core (via context switching).
3. [[Windows NT and Windows 98#Concurrency and Parallelism in Windows|Parallelism]] - Multiple tasks run at the same time on multiple cores/CPUs.
