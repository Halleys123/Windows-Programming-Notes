...
All the limitation that were faced during that time period gave rise to [[4 - Double Byte Character Set|Double Byte Character Sets]] and ultimately to [[5 - Unicode|unicode]].
