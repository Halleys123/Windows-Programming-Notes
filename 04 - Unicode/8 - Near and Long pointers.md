...
- When the Intel 80386 processor was released, it introduced true 32-bit hardware registers. A single 32-bit register can count from 0 up to 4,294,967,295.
...
<iframe width="100%" height=600px src="http://localhost:82/near_far_pointer_explainer.html"></iframe>
	
<iframe width="100%" height=600px src="http://localhost:82/pointer_bit_layout_interactive.html"></iframe>